      ...
      <nav class="navbar">
        <div class="container-fluid">
          ...
          <form class="d-flex" method="get" role="search">
            <a href="search.php" class="btn btn-outline-success" type="submit">Go to Search</a>
          </form>
        </div>
      </nav>
      <!-- Modal -->
                    ...
                    ?>
                        <tr>
                            ...
                            if($row['Status'] == 'Active'){
                              echo '<span style="letter-spacing: 1px;" class="badge text-bg-success">'. $row['Status'] .'</span>';
                            }else{
                              echo '<span style="letter-spacing: 1px;" class="badge text-bg-danger">'.$row['Status'].'</span>';
                            }
                              ?>
                              </td>
                            <td>
                                <a href="edit/edit.php?ID=<?php echo $row['ID']?>" class="link-dark"><i  class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                <a href="includes/delete.php?ID=<?php echo $row['ID']?>" class="link-dark"><i  class="fa-solid fa-trash fs-5"></i></a>
                            </td>
                        </tr>
                        <?php
                    }
